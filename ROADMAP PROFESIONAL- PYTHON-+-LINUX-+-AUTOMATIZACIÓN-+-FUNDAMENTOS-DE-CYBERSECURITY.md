# ROADMAP PROFESIONAL — PYTHON + LINUX + AUTOMATIZACIÓN + FUNDAMENTOS DE CYBERSECURITY
...
## 2.8 Expresiones regulares *(nuevo)*
...
## 3.4 Argumentos en línea de comandos *(nuevo)*
...
## 3.5 Manejo de secretos y variables de entorno *(nuevo)*
...
## 4.5 Automatización SSH con Python *(nuevo)*
...
*Versión 2.0 — Revisión completa con correcciones en nomenclatura, temas faltantes agregados (regex, datetime, argparse, concurrencia, paramiko, python-dotenv, journalctl, docker-compose, OWASP actualizado) y módulo 6 reenfocado.*
